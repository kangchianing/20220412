...
class MainActivity : AppCompatActivity() ,GestureDetector.OnGestureListener ,GestureDetector.OnDoubleTapListener, View.OnTouchListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        while (res != 0) {
            countDrawables++;
            res = getResources().getIdentifier("pu" + countDrawables.toString(),"drawable", getPackageName());
        }
    ...
    fun ShowPicture() {
        ...
        when (PictureNo) {
            ...
            5 -> img.setImageResource(R.drawable.pu5)
        }
         */
        txv.text = PictureNo.toString()
        var res:Int = getResources().getIdentifier("pu" + PictureNo.toString(),"drawable", getPackageName())
